...
//        UINavigationBar.backgroundColor = UIColor(red: 60.0/255.0, green: 64.0/255.0, blue: 67.0/255.0, alpha: 1.0)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.app.RodKom" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("RodKom", withExtension: "momd")!
    ...
    func readJSON (fileName : String) -> [Dictionary<String, AnyObject>] {
